...
public class Dijkstra {
    ...
    private final Iterable<Edge> arestas;
    ...
    private int getDistance(Vertex node, Vertex target) {
        for (Edge edge : arestas) {
            if (edge.getVertex(Direction.OUT).equals(node) && edge.getVertex(Direction.IN).equals(target)) {
    ...
    private List<Vertex> getNeighbors(Vertex node) {
        ...
        for (Edge edge : arestas) {
            if (edge.getVertex(Direction.OUT).equals(node) && !isSettled(edge.getVertex(Direction.IN))) {
